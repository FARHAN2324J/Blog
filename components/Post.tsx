...
const Post = () => {
  ...
  const SkeletonCard = () => (
    <article className="bg-(--secondary-color) w-fit flex lg:flex-row flex-col p-5 rounded-[36px] m-auto animate-pulse">
            ...
            <article
              ...
              style={{
                transitionTimingFunction:
                  "cubic-bezier(0.165, 0.285, 0.22, 2.25)",
              }}
            >
              <div className="relative w-[320px] h-45">
                <Image
              ...
              <div className="lg:ml-5 lg:mt-0 mt-5 ">
                <div className="flex gap-2 items-center mb-2">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="span">{d.read_time} min</span>
                  </div>
                </div>
